...
import SteeringExploringMapScene from './steering-exploring-map-scene';
import SteeringTradeRouteScene from './steering-trade-route-scene';
...
const scenes = [
    ...
    ['SteeringExploringMapScene', SteeringExploringMapScene],
    ['SteeringTradeRouteScene', SteeringTradeRouteScene]
];
