...
import WorldMap from '../src/game-objects/world-map';
import Footsteps from "../assets/audio/footstep_ice_crunchy_run_01.wav";

import ExploreMap from "../src/ai/steerings/explore-map"

let SteeringExploringMapScene = new Phaser.Class({
    ...
    initialize:
        ...
        function StartingScene() {
            Phaser.Scene.call(this, {key: 'SteeringExploringMapScene'});
        },
    ...
    create: function () {
        ...
        const worldMap = new WorldMap(this.physics.world, 4);

        this.explorer = this.characterFactory.buildCharacter('green', 300, 150, {Steering: new ExploreMap(this, worldMap)});
...
export default SteeringExploringMapScene;